	...
	if (!result) {
		exports.respond(
			...
			exports.respEntity(
				null,
				422,
				validatorResult.errors.map((err) => err.msg).join(",")
			),
			422
		);
	}
...
exports.respondOrRedirect = function (
	{ req, res },
	url = "/",
	obj = {},
	status = 200
...
exports.createNickname = () => {
	...
	let nickName = [];
	while (nickNameLen) {
		nickName[nickName.length] = str.substr(
...
exports.renderEmojiPanelHtml = function (emoji) {
	return new Promise((resolve, reject) => {
		ejs.renderFile(
			path.join(__dirname, "../view/common/emojiPanel.html"),
			{
				emojiTabs: emoji,
			},
			(err, str) => {
...
exports.renderSubCommentListHtml = function (
	subComments,
	user,
	allowComment = true
) {
